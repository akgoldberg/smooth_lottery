...
3. **Try running the MERIT selection algorithm**: test that your setup worked, by walking through an example of running the MERIT selection algorithm in the iPython notebook **`Getting_Started_Example.ipynb`.**
